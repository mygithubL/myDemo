...
//返回1识别成功，返回1识别失败
int Trace_goal(const TARGET_CONDI *Condition,RESULT *Resu);
int Trace_zone1(const TARGET_CONDI *Condition,RESULT *Resu);
int Trace_zone2(const TARGET_CONDI *Condition,RESULT *Resu);
